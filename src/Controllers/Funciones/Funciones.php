...
class Funciones extends PublicController
{
  ...
  {
    $this->partialDescripcion = Context::getContextByKey("funciones_partialDescripcion");
  ...
  {
    Context::setContext("funciones_partialDescripcion", $this->partialDescripcion, true);
