...
class Roles extends PublicController
{
    ...
    {
        $this->partialDescripcion = $_GET["partialDescripcion"] ?? $this->partialDescripcion;
    ...
    {
        $this->partialDescripcion = Context::getContextByKey("roles_partialDescripcion");
    ...
    {
        Context::setContext("roles_partialDescripcion", $this->partialDescripcion, true);
    ...
    {
        $this->viewData["partialDescripcion"] = $this->partialDescripcion;
